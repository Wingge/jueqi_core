...
public class PreferencesUtil {
    ...
    private static String preferrenceName;


    private static String getPreferrenceName(Context context){
        if(TextUtils.isEmpty(preferrenceName)){
            preferrenceName = AppInfoUtil.getApplicationName(context);
        }
        return  preferrenceName;
    }
    /**
    ...
    public static void saveValue(Context context, String key, int value) {
        if (context != null) {
            SharedPreferences pre = context.getSharedPreferences(getPreferrenceName(context), Context.MODE_PRIVATE);
